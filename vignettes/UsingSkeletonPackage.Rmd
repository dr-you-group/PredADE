...
Make sure to have RStudio installed.  Then open the R project downloaded from ATLAS by decompressing the downloaded folder and clicking on the <PredADE>.Rproj file (where <PredADE> is replaced by the study name you specified in ATLAS).  This should open an RStudio session.

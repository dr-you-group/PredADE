...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/PredADE/inst/doc/UsingSkeletonPackage.pdf)
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/PredADE")
```

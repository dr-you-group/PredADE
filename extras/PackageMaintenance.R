...
OhdsiRTools::checkUsagePackage("PredADE")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/PredADE.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PredADE.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("PredADE")
